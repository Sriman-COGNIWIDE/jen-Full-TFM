...
sudo -u ec2-user python3 -m pip install --user flask flask-sqlalchemy aws-secretsmanager-caching psycopg2-binary awscli boto3 six bleach blinker certifi click colorama distlib filelock itsdangerous Jinja2 MarkupSafe marshmallow marshmallow-sqlalchemy packaging pipenv platformdirs setuptools SQLAlchemy SQLAlchemy-Utils typing_extensions virtualenv webencodings Werkzeug

aws s3 cp s3://lambda-codes-zips/prj.py /home/ec2-user/app.py
