...
# output "get_rcp_url" {
#   value = module.http_api_gateway.get_recipes_url
# }

# output "get_by_id_rcp_url" {
#   value = module.http_api_gateway.get_recipe_by_id_url
# }

# output "post_rcp_url" {
#   value = module.http_api_gateway.post_recipe_url
# }

# output "put_rcp_url" {
#   value = module.http_api_gateway.put_recipe_url
# }

# output "dlte_rcp_url" {
#   value = module.http_api_gateway.delete_recipe_url
# }
