module "get_lambda" {
  ...
  payload_file = "${path.module}/json/get_lambda_payload.json"
...
module "get_by_id_lambda" {
  ...
  payload_file = "${path.module}/json/get_by_id_lambda_payload.json"
  deployment_mode = "terraform"
  run_test = true
}
...
module "post_lambda" {
  ...
  payload_file = "${path.module}/json/post_lambda_payload.json"
  deployment_mode = "terraform"
...
module "put_lambda" {
  ...
  payload_file = "${path.module}/json/put_lambda_payload.json"
  deployment_mode = "terraform"
...
module "delete_lambda" {
  ...
  payload_file = "${path.module}/json/delete_lambda_payload.json"
  deployment_mode = "terraform"
