...
resource "aws_iam_policy" "s3_access_policy" {
  ...
  description = "policy for ec2-s3 accessing"
...
resource "aws_iam_instance_profile" "ec2_s3_profile" {
  ...
  depends_on = [aws_iam_role_policy_attachment.s3_access_attachment, aws_iam_role_policy_attachment.secrets_access_attachment]
}
